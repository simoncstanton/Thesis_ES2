...
#PBS -o /u/__USER__/__BASEPATH__/results/obs_exp/pbs_output/
#PBS -e /u/__USER__/__BASEPATH__/results/obs_exp/pbs_output/
...
RESULTS_DIR=~/__BASEPATH__/results/experiments/selfplay_parameter_study/$PARENT_JOBID/$JOB_DIR
